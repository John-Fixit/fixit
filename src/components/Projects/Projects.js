...
function Projects() {
  const projects = [
    ...
    {img: ens, title: "Emergency Notification System(ENS)", desc: "Emergency Notification system is developed using React, Node Js, MongoDB, Express, Socket.io. ENS features such that, it is used for an emergency situation. This ENS include two part, the user and admin part. all user can make use of the application while the admin will recieve the emergency message sent by the user at their end", gitLink: "https://github.com/John-Fixit/Emergency-system-frontend", demoLink: "https://ens-pro.netlify.app/"},
    {img: cv, title: "CV Creator", desc: "CV createor was developed using Next Js, mongoDB, Express. it can be used to develop cv", gitLink: "https://github.com/John-Fixit/CV-creator", demoLink: "https://create-my-cv.vercel.app/"},
